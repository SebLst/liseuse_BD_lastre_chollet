...
void makeMenuBar(wxMenuBar *menuBar)
{
    ...
    // open file item
    wxMenuItem *openItem = new wxMenuItem(fileMenu,
                                          window::id::OPEN_FILE,
                                          _("Open file\tCTRL+O"),
                                          _("Open an image or a compressed comic book"));
    ...
    // open directory item
    wxMenuItem *openFolderItem = new wxMenuItem(fileMenu,
                                                window::id::OPEN_DIRECTORY,
                                                _("Open directory\tCTRL+D"),
                                                _("Open a directory containing your files"));
    ...
    // rar menu item
    wxMenuItem *rarItem = exportMenu->Append(wxID_ANY,
                                             _("&RAR"),
                                             _("Export as a .cbr file"));
    fileMenu->AppendSubMenu(exportMenu,
                            _("&Export as"),
                            _("Export your collection of images as..."));

    fileMenu->AppendSeparator();
    // help menu item
    wxMenuItem *helpItem = new wxMenuItem(fileMenu, wxID_HELP,
                                          _("Help"),
                                          _("Need some help?"));
    ...
    // hide/open bookmark tab
    wxMenuItem *bookmarkHideItem = new wxMenuItem(navigationMenu,
                                                  window::id::HIDE_BOOKMARK_PANEL,
                                                  _("Hide/Show bookmarks"),
                                                  _("Displays or hides the bookmarks panel"));
    navigationMenu->Append(bookmarkHideItem);
